...
if (isset($_POST["submit"])) {
    ...
    $_unit_kerja_id = $_POST['unit_kerja_id']; // Diubah dari $_kelurahan_id
    $data = [$_nama, $_gender, $_tmp_lahir, $_tgl_lahir, $_kategori, $_telpon, $_alamat, $_unit_kerja_id]; // Diubah dari $_kelurahan_id
    $sql = "INSERT INTO dokter (nama, gender, tmp_lahir, tgl_lahir, kategori, telpon, alamat, unit_kerja_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"; // Diubah dari $_kelurahan_id
