...
// Ambil data ID pasien dari tabel pasien
$queryPasien = $dbh->query("SELECT id FROM pasien")->fetchAll(PDO::FETCH_ASSOC);

// Ambil data ID dokter dari tabel dokter
$queryDokter = $dbh->query("SELECT id FROM dokter")->fetchAll(PDO::FETCH_ASSOC);
?>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h2 class="text-center">Form Edit Periksa</h2>
