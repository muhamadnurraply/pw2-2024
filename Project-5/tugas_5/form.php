...
<head>
    ...
    <style>
        body {
            background: linear-gradient(135deg, #3F8CAC, #9B23D7);
            color: #ffffff;
        }
    </style>
</head>
...
<body>
    <div class="container">
        <h1 class="text-center mb-4">BMI Pasien</h1>
    ...
    ?>
        <div class="mt-5 p-2 m-4 border rounded" style="background-color: #333; color: #fff; font-size: 14px; padding: 10px;">
            ...
            <p>Umur: <?php echo $pasien->umur; ?> tahun</p>
            <p>Jenis Kelamin: <?php echo $pasien->jk; ?></p>
            <p>Hasil BMI: <?php echo $pasien->hasilBMI(); ?></p>
            <p>Status BMI: <?php echo $pasien->statusBMI(); ?></p>
        </div>
    <?php } ?>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.min.js" integrity="sha384-+sLIOodYLS7CIrQpBjl+C7nPvqq+FbNUBD